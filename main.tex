...
\small{\textbf{Figure 2.} Left, a photograph of the pad plane end of the AT-TPC, shown mounted in the solenoid magnet.}

\small{\textbf{Figure 3.} Right, this is a schematic of the AT-TPC with the outer shielding made transparent. The rare isotope beam enters the the detector on the right-hand side and moves left towards the sensor plane \cite{Bradt-thesis}.}
...
\begin{center}
\includegraphics[width=30mm]{ar40_nucleus.png}
\end{center}

\small{\textbf{Figure 1.} This is a diagram depicts an $^{40}$Ar nucleus.}
}
%----------------------------------------------------------------------------------------
%	40AR ANALYSIS
%----------------------------------------------------------------------------------------
...
\small{\textbf{Figure 5.} Left, this is an example of a proton event rendered in the pytpc framework.}

\small{\textbf{Figure 6.} Center, this histogram shows the distribution of $\chi_{pos}^{2}$ values. This component was cut at 14.}

\small{\textbf{Figure 7.} Right, this plot shows the distribution of vertex positions in the plane transverse to the detector.}

\begin{center}
\includegraphics [width=100mm] {angular_excitation_hists_POSTER.pdf}
\end{center}
\small{\textbf{Figure 8.} Unnormalized excitations functions as a function of the $^{40}$Ar vertex energy in the laboratory frame shown for multiple center-of-mass scattering angles ($\theta_{cm}$).}
}
...
\end{center}
\textbf{Figure 4.} From left to right,  here are examples of a preprocessed event, an event after the Hough Transform cleaning, and a Monte Carlo fit event.}
