...
\documentclass[ansiepaperDNP,portrait]{baposterDNP}
...
{\small{The analysis code, originally written for $^{46}$Ar data, was applied to data from the $^{40}$Ar(p, p) experiment that ran at the NSCL in August,  2015.}
...
\small{\textbf{Fig 5.} Left, the NSCL beamline with labels. The beam starts at the ion sources (1) and ends at the AT-TPC (14) \cite{Bradt-thesis}.}
